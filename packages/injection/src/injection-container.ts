...
export class InjectionContainer {
  ...
  public resolve<T extends object = any>(token: Utils.Factory<T>, options?: InjectionRegistration.ResolutionOptions): T

  public resolve<T extends object = any>(token: Utils.Constructor<T>, options?: InjectionRegistration.ResolutionOptions): T
