import { ConstructorUtils } from './utils-constructor'
...
describe('ConstructorUtils', () => {
  describe('extractParameters', () => {
    it('should return class constructor parameters', () => {
     ...
     const result = ConstructorUtils.extractParameters(SomeClass)
    ...
    it('should return anonymous class constructor parameters', () => {
      const result = ConstructorUtils.extractParameters(class {
        public constructor(param1: string, param2: number) {
          throw new Error('Not to be called!')
        }
      })
