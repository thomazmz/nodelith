...
export type ConstructorType<R extends object = object, P extends Array<any> = Array<any>> = 
  | ( new (...argumentz: P) => R ) 
  | { new (...argumentz: P): R }

export declare namespace ConstructorUtilities {
  export type Instance<C extends ConstructorType> = InstanceType<C>
  export type Parameters<C extends ConstructorType> = C extends new (...args: infer P) => any ? P : never
}

export const ConstructorUtilities = Object.freeze({
  extractParameters(target: ConstructorType): string[] {
