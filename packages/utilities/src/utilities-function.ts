...
export type FunctionType<R = any, P extends Array<any> = any[]> = (...args: P) => R

export declare namespace FunctionUtilities {
  export type Return<F extends FunctionType> = ReturnType<F>
  export type  Prameters<F extends FunctionType> = Parameters<F>
}

export const FunctionUtilities = Object.freeze({
  extractParameters(target: FunctionType): string[] {
